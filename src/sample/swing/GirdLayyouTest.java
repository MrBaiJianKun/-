...
class GridLayoutTest extends JFrame {
    ...
    private void init() {
        ...
        panels[0].setBackground(new Color(41,204,175));
        // 在第一个面板内加入五个按钮
        for (int i = 0; i < 5; i++){
        ...
        panels[1].setBackground(new Color(247,105,52));
        // 五个方向加入按钮
        ...
        for (int i = 0; i < 9; i++){
            panels[3].add(new JButton("JButton"));
        }
        //第五个面板
        ...
        panels[6].setBackground(new Color(123,105,52));
        // 五个方向加入按钮
        ...
        //第九个面板
        panels[8].setBackground(new Color(231,254,52));
